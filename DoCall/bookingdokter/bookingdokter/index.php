...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			...
			<hr>
			<p class="lead">Silahkan Daftar dan Cek Dokter Yang Tersedia</p>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="form-group">
				...
				<select class="form-select form-control" name="dokter" id="dokter" >
						...
						<option value="Dokter Hadriansyah">Dokter Hadriansyah</option>
						<option value="Dr.Rayhan Shafitri">Dr.Rayhan Shafitri</option>
						<option value="Dr.Syarifah Nora Andriaty, M.Pd.Ked">Dr.Syarifah Nora Andriaty, M.Pd.Ked</option>
						<option value="Dr.Muhammad Iqbal Saputra,MKM">Dr.Muhammad Iqbal Saputra,MKM</option>
				</select>
			</div>
		</div>
		<div class="col-3">
