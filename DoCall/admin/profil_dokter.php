...
<h3>Halaman Input Data Dokter</h3>
<p>
    <a href="dokter_input.php">
        <input type="button" class="btn btn-primary" value="Buat Data Profil Dokter" />
    </a>
</p>
<p>
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="dokter.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Yakin hapus data?')">
