...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($id != ""){
            $sql1   = "update halamaninput set judul = '$judul',kutipan='$kutipan',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into halamaninput(judul,kutipan,isi) values ('$judul','$kutipan','$isi')";
        }
