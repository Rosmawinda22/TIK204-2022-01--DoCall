...
<head>
  ...
  <meta name="author" content="Yuni Eriza">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang<strong></strong>, Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <p class="mb-4">Halaman Panggilan Antrian digunakan petugas untuk memanggil antrian pasien.</p>
